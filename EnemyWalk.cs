...
public class EnemyWalk : MonoBehaviour
{
    ...
    #region 角色翻轉
    /// <summary>
    /// 之後才知道Unity中有x翻轉的選項，不過我們也會做面向左或右的判定
    /// </summary>
    void FlipToL()
    {
        if (_isFacingRight)
    ...
    #region 追擊
    /// <summary>
    /// 追擊狀態，直到玩家逃離WarningRange的範圍才會停止
    /// </summary>
    void Chase()
    {
        rb.drag = 2.5f;
